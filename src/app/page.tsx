          ...
          <div className="flex items-start justify-between gap-10">
            <div>
              ...
              <p className="annotation mt-8" style={{ maxWidth: "460px", lineHeight: 1.7 }}>
                — Materiales del cuatrimestre en curso, audios y videos de las clases, Lexpodcast, transcripciones y más, <span style={{ color: "var(--color-stamp)" }}>foliados por materia.</span> —
              </p>
            </div>
