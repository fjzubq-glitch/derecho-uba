...
export default function CalendarioClient({ initialMateria, slug }: CalendarioClientProps) {
  ...
  const fechas = useMemo(() => initialMateria?.fechas ?? [], [initialMateria]);
  ...
  const { title: materiaTitle, meta: materiaMeta } = initialMateria ? splitName(initialMateria.nombre) : { title: "", meta: null };
