        ...
        <div className="pad-lateral" style={{ padding: "40px 48px 80px" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <div className="flex items-center justify-between" style={{ paddingTop: "12px", borderTop: "1px solid var(--color-line-soft)" }}>
                        <span style={{ fontFamily: "var(--font-ibm-plex-mono)", fontSize: "11px", color: "var(--color-text-muted)" }}>
                          {formatearFechaCorta(pf.fecha, true)}
                        </span>
                        <span style={{ padding: "3px 10px", border: `1px solid ${dias <= 7 ? "var(--color-stamp)" : "var(--color-gold-dim)"}`, fontFamily: "var(--font-ibm-plex-mono)", fontSize: "10px", letterSpacing: "0.1em", textTransform: "uppercase", color: dias <= 7 ? "var(--color-stamp)" : "var(--color-gold)" }}>
                          {countdownLabel(dias)}
                        </span>
                      </div>
                    </>
            ...
            {materia?.tutor_url && (isAdminSession() || acceso?.clave) && (
              <article className="card-reveal card-hover h-full" style={{ background: "var(--color-card)", padding: "28px 24px", border: "1px solid var(--color-line-soft)", borderRadius: "var(--radius-card)", transition: "background 0.25s ease, border-color 0.25s ease" }} onMouseEnter={(e) => { e.currentTarget.style.background = "var(--color-card-hover)"; e.currentTarget.style.borderColor = "var(--color-gold-dim)"; }} onMouseLeave={(e) => { e.currentTarget.style.background = "var(--color-card)"; e.currentTarget.style.borderColor = "var(--color-line-soft)"; }}>
                ...
                <div className="flex items-center justify-between" style={{ marginTop: "16px", paddingTop: "12px", borderTop: "1px solid var(--color-line-soft)" }}>
                  <span style={{ fontFamily: "var(--font-ibm-plex-mono)", fontSize: "11px", color: "var(--color-text-muted)" }}>NotebookLM</span>
                  <a href={materia.tutor_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2" style={{ fontFamily: "var(--font-ibm-plex-mono)", fontSize: "10px", letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--color-admin)", textDecoration: "none" }}>
                    Consultar <ExternalLink style={{ width: "12px", height: "12px" }} />
                  </a>
                </div>
              </article>
            )}
