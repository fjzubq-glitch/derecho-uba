  ...
  return (
    ...
    >
      ...
      <div className="mb-8">
        ...
        <div style={{ padding: "24px", border: "1px solid var(--color-line-soft)", borderRadius: "var(--radius-card)" }}>
...
Clase Virtual
          ...
          <div className="space-y-3">
            ...
            {claseYoutubeItems.map((item, idx) => (
              <div key={idx} className="space-y-3" style={{ padding: "16px", border: "1px solid var(--color-line-soft)", borderRadius: "var(--radius-card)" }}>
        ...
        <div style={{ padding: "24px", border: "1px dashed var(--color-gold-dim)", borderRadius: "var(--radius-card)" }}>
          <h3 style={sectionHeaderStyle}>
