      ...
      {vistaFicha && (
        <div style={MODAL_STYLE} onClick={(e) => { if (e.target === e.currentTarget) setVistaFicha(null); }}>
          <div style={{ ...MODAL_BOX, maxWidth: "920px", padding: "44px 80px 40px" }}>
            ...
            <div className="ficha-view" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(vistaFicha.contenido, { ADD_TAGS: ["iframe", "input", "label", "details", "summary"], ADD_ATTR: ["allow", "allowfullscreen", "frameborder", "scrolling", "style", "type", "checked", "open", "data-checked", "data-type"] }) }} />
