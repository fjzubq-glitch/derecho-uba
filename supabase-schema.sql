...
CREATE TABLE IF NOT EXISTS archivos (
  ...
  tipo TEXT CHECK (tipo IN ('audio_clase', 'clase_youtube', 'podcast', 'transcripcion', 'archivo', 'enlace', 'youtube', 'cuestionario', 'material_privado', 'ficha', 'lexpodcast')),
...
-- Tabla de fichas (contenido personal del admin)
